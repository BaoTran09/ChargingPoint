    ...
    public partial class Form1 : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void ManaTransition_Tick(object sender, EventArgs e)
        {
            if (manaExpand == false)
            {
                ...
                flPl_ManagementContainer.Height += 5;

                if (flPl_ManagementContainer.Height == 275)
                {
                    ManaTransition.Stop();
                ...
                flPl_ManagementContainer.Height -= 5;
                if (flPl_ManagementContainer.Height <= 55) 
                {
        ...
        private void accountTransition_Tick(object sender, EventArgs e)
        {
            if (accountExpand == false)
            {
                ...
                if (flPl_AccountingContainer.Height == 330)
                {
        ...
        /*        private void btnChungTu_Click(object sender, EventArgs e)
                {
                    if (frmChungTu == null)
                    {
                        frmChungTu = new Accounting.frmChungTu(); // Dùng mặc định invoiceId
                        frmChungTu.FormClosed += frmChungTu_FormClosed;
                        frmChungTu.MdiParent = this;
                        frmChungTu.Dock = DockStyle.Fill;
                        frmChungTu.Show();
                    }
                    else
                    {
